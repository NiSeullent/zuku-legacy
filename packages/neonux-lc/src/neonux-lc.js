        ...
        for (i = 0; i < limit; i += 1) {
            if (elements[i].getAttribute("data-lc-surface") === "status") {
                if (mode !== "auto") {
                    ...
                    graphic.clear();
                    graphic.rect(0, 28, 160, 1, "{{neon-border-subtle}}");
                    graphic.rect(0, 12, 8, 16, "{{neon-accent}}");
                    graphic.rect(14, 4, 8, 24, "{{neon-accent}}");
                    graphic.rect(28, 8, 8, 20, "{{neon-accent}}");
                    graphic.line(50, 18, 156, 18, "{{neon-text-muted}}", 1);
