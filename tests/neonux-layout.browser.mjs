...
<a class="lc-skip" href="#main">본문 바로가기</a><div class="lc-shell"><div class="lc-header"><a class="lc-brand" href="/"><span class="lc-brand-mark">Z</span> ZUKU <span class="lc-badge">LEGACY</span></a><p class="lc-muted">작은 기기에서도, 같은 세계로.</p><p class="lc-header-actions"><a class="lc-button" href="/login">계정 연결</a><a class="lc-button" href="/settings">화면 설정</a></p></div>
<div class="lc-layout"><div class="lc-sidebar"><p class="lc-eyebrow">YOUR ZUKU</p><ul class="lc-nav">${['둘러보기','Thread','Hype','Swipe','Jump','Vive','Vine','보관함','메시지'].map((name) => `<li><a href="/">${name}</a></li>`).join('')}</ul><div class="lc-panel"><div class="lc-panel-body"><p class="lc-badge">HTTP · 공개 열람</p><p class="lc-muted">가벼운 화면 · 자동 재생 없음</p><a href="/compatibility">지원 기능 보기</a></div></div></div>
...
try {
  for (const width of [320, 480, 1024]) for (const baseFontSize of [16, 24, 32]) {
    ...
    if (width === 1024 && baseFontSize === 16) {
      assert.ok(layout.nav.height < 60, `Nine navigation tabs should fit one compact desktop row: ${layout.nav.height}`);
